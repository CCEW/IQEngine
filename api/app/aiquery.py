...
rf_function = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "min_modified": {"type": "string", "description": "Min metadata modified date"},
                "max_modified": {"type": "string", "description": "Max metadata modified date"},
                "signal_type": {"type": "string", "description": "AeroLake signal type"},
                "hw": {"type": "string", "description": "Recording hardware"},
                "location": {"type": "string", "description": "Longitude, latitude, radius in meters"},
                "operator": {"type": "string", "description": "Recording operator"},
                "recorder": {"type": "string", "description": "Recording software or recorder"},
